...
const project = knowledgeData.project;
...
function generateResponse(query) {
  ...
  if (greetings.includes(qLower)) {
    return {
      text: `Welcome to SynapseNet — A Decentralized Intelligence Network.\n\n"${project.quote}"\n\nI can answer questions about: the project overview, how it works, Proof of Emergence, NGT tokens, security layers, NAAN agents, Web 4.0, Tor integration, P2P networking, architecture, Docker, Tauri desktop app, and much more.\n\nWhat would you like to know?`,
      sources: []
    };
  }
  ...
  return { text: response.trim(), sources };
}
